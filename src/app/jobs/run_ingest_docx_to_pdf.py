# ==============================================================================
# 목적 : Docx에서 Parsing 후 데이터를 DB에 적재를 실행하는 코드
# 최초 작업자 : (AI솔루션/박태원)
# 최초 작업일 : 2026-01-23
# AI 활용 여부 :
# ==============================================================================
...
from app.workflows.ingest_docx_to_pdf import ingest_with_config
...
def setup_logging():
    ...
    logging.getLogger("app.storage.opensearch").setLevel(logging.WARNING)
...
def main() -> int:
    ...
    try:
        result = ingest_with_config(config_path=config_path)
    except Exception:
